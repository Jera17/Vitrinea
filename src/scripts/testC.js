...
function onResultsFaceMesh(results) {
  ...
  if (results.multiFaceLandmarks[0]) {
    results.multiFaceLandmarks[0].forEach(multiFaceLandmarks => {
      ...
      drawPoint(ctx, multiFaceLandmarks.x, multiFaceLandmarks.y, 2, "red")
    });
    simImage(results.multiFaceLandmarks[0], 127, 356, 168)
    drawPoint(ctx, results.multiFaceLandmarks[0][127].x, results.multiFaceLandmarks[0][127].y, 4, "blue")
    drawPoint(ctx, results.multiFaceLandmarks[0][356].x, results.multiFaceLandmarks[0][356].y, 4, "blue")
  }
}
